...
const ProfileEdit = () => {
  ...
  const fetchUserDetails = () => {
    ...
    // Simulating fetch from local storage
    const userData = JSON.parse(localStorage.getItem('userData')) || {};
    setUsername(userData.username || '');
    setRoleDescription(userData.roleDescription || '');
    setOtherRoleDescription(userData.otherRoleDescription || '');
    ...
    setDisability(userData.disabilityStatus || '');
    setCvFile(userData.resume || null);
